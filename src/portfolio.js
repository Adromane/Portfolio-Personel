  ...
  data: [
    ...
    },
    {
      ...
      skills: [
        ...
        "⚡ Developpement d'applications mobiles a l'aide de Flutter, React Native et d'applications Android solo a l'aide de Kotlin",
        "⚡Creation du backend de l'application dans Node, Express & Flask",
      ],
      softwareSkills: [
        {
          skillName: "HTML5",
    ...
    },
    {
      ...
      skills: [
        ...
        "⚡Hébergement et maintenance de sites Web sur des instances de machines virtuelles avec integration de bases de donnees",
        "⚡Déploiement de modeles d'apprentissage en profondeur sur le cloud a utiliser sur les appareils mobiles",
  ...
  sections: [
    {
      ...
      experiences: [

        {
          ...
          location: "Dakar",
          description:
            "Passionné de développement web, réseaux & technologies. Je partage mes projets, mon apprentissage et des astuces pour évoluer dans la tech. 🚀",
          color: "#0879bf",
        },
        {
