...
const greeting = {
  ...
  subTitle:
    "Bonjour, je m'appelle Patrick Vieira Gomes, un développeur Web passionné par la création de sites Web innovants et fonctionnels. En tant que développeur Web, j'aime travailler en étroite collaboration avec mes clients pour comprendre leurs besoins et leurs objectifs commerciaux.",
  resumeLink:
