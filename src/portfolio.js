  ...
  sections: [
    {
      ...
      experiences: [
        ...
        },
        {
          ...
          location: "Dakar",  
          description:
            "Je partage sur mon GitHub divers projets de développement, incluant des applications web et des solutions open-source. Explorez mon code en [tes technologies principales] et mes collaborations!",
          color: "#0879bf",
        },
        {
          title: "Linkedin",
